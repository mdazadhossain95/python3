...
def test_labels():
    assert lookup('utf-8')._name == 'utf-8'
    assert lookup('Utf-8')._name == 'utf-8'
    assert lookup('UTF-8')._name == 'utf-8'
    assert lookup('utf8')._name == 'utf-8'
    assert lookup('utf8')._name == 'utf-8'
    assert lookup('utf8 ')._name == 'utf-8'
    assert lookup(' \r\nutf8\t')._name == 'utf-8'
    ...
    assert lookup('US-ASCII')._name == 'windows-1252'
    assert lookup('iso-8859-1')._name == 'windows-1252'
    assert lookup('latin1')._name == 'windows-1252'
    assert lookup('LATIN1')._name == 'windows-1252'
